    ...
    <section style={styles.heroSection} id="home">
      ...
      <div style={styles.heroContent}>
        ...
        <p style={styles.description}>
          From organizing local clean-ups to managing impactful events, <strong>EX</strong> provides a platform for 
          volunteers and organizers to connect, collaborate, and drive positive change. Join us to create a meaningful impact.
